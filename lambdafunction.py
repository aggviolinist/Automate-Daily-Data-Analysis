...
s3_bucket_name = "[my-analysis-buckooo]"
...
def lambda_handler(event,context):
    ...
    while query_status !='SUCCEEDED':
        ...
        results_s3_location = f's3://{s3_bucket_name}/processed/{current_date}/' + query_execution_id + '.csv'

        return{
            'statusCode': 200,
            'body' : json.dumps({
                'message': 'Query executed successfully!',
                'result_s3_location': results_s3_location
            })
        }
